...
<head>
    <title>Surat Kenaikan Gaji</title>
</head>
    ...
    <?php if (isset($_POST['preview'])) {
      echo $_POST['tes'];
        ...
        <div class="container">
            ...
            <p></p>
            <p></p>
            <tr><td style="width:70%"></td><td><u>Tembusan, disampaikan kepada Yth :</u></td></tr><br>
            <tr><td style="width:70%"></td><td><?php echo $_POST['tembusan'];?></td></tr>
            <p></p>
            <p></p>
            <p></p>
            <p></p>
...
$nama_dokumen = 'Surat Kenaikan Gaji';
